...
extern uint32_t *restore_context(uint32_t *) __attribute__((section(".kernel"), naked));
extern uint32_t *faux_restore_context(void (*fptr)(void), void (*lptr)(void)) __attribute__((section(".kernel"), naked));
