...
void init_spi(void) {
    ...
    *GPIOA_AFRL  |= (GPIO_AF_SPI12 << (1 * 4)) | (GPIO_AF_SPI12 << (6 * 4)) | (GPIO_AF_SPI12 << (7 * 4));
    ...
    *SPI1_CR1 |= SPI_CR1_BR_8 | SPI_CR1_CPOL | SPI_CR1_CPHA | SPI_CR1_DFF | SPI_CR1_MSTR | SPI_CR1_SSM | SPI_CR1_SSI;
